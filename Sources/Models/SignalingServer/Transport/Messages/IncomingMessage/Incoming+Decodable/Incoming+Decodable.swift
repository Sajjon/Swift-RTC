...
private extension RadixSignalMsg.Incoming {
...
#if DEBUG
extension RadixSignalMsg.Incoming: Encodable {}
public extension RadixSignalMsg.Incoming {
        ...
        case let .fromSignalingServerItself(fromSignalingServerItself):
            ...
            case let .responseForRequest(responseForRequest):
                ...
                case .failure(let failure):
                    switch failure {
                    case .invalidMessageError(let error):
                    ...
                    case .noRemoteClientToTalkTo(let requestId):
